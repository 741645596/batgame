...
static public class NGUITools
{
    ...
    static public AudioSource QFordPlaySound(AudioClip clip,float delay=0f) { return PlaySound(clip, 1f, 1f); }
	...
	static public AudioSource PlaySound (AudioClip clip, float volume, float pitch,float delay = 0)
	{
		volume *= soundVolume;
