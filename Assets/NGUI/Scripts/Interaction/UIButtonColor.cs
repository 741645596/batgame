...
public class UIButtonColor : UIWidgetContainer
{
	...
	protected virtual void OnEnable ()
	{
		...
		{
			if (UICamera.currentTouch.pressed == gameObject && UICamera.currentTouch.pressStarted) OnPress(true);
	...
	{
		if (isEnabled && UICamera.currentTouch != null && UICamera.currentTouch.dragStarted == false)
		{
			if (!mInitDone) OnInit();
	...
	protected virtual void OnDragOver ()
	{
		...
		{
			if (!mInitDone) OnInit();
			if (tweenTarget != null) SetState(State.Drag, false);
		}
	}
