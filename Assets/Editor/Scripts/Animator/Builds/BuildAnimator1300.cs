...
public class BuildAnimator1300 : Editor{
	/*[MenuItem("Tool/AnimatorOver/builds/1300--金币房")]
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
        string strBuildID = "1300";
		string strBuildPartName = "1300";
	...
	private static void AddStates (string strBuildID,string strBuildPartName, ref UnityEditor.Animations.AnimatorControllerLayer layer)
	{
		...
		AddState (strBuildID,strBuildPartName,"10000","20000","10000","Stand", ref layer ,ref dicState);
		AddState (strBuildID,strBuildPartName,"20000","20000","20000","Hit", ref layer ,ref dicState);
		...
		AddStateTransition(null, dicState ["20000"], "iState", TransitionConditionMode.Equals, 20000f, ref layer);

		//srcState 20000
		string strCurStateKey = "20000";
