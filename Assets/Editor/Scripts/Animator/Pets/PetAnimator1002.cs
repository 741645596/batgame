...
public class PetAnimator1002 : Editor {
	[MenuItem("Tool/AnimatorOver/Pets/1002-蹦蹦")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "1002";
		string strRolePartName="1002";
...

		{
				...
				AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/1002@Over.overrideController");
	...
	{
		bool bPair = false;
		string strCliPath = "Assets/Models/Pets/"+strRoleID+"/"+strRolePartName+"@"+strClipSourceName+".FBX";
		if(strClipName=="")
