...
/// 熊孩子
/// </summary>
public class RoleAnimator102005 : Editor
{
    [MenuItem("Tool/AnimatorOver/Roles/102005-小奶熊")]
	...
	static void DoCreateAnimationAssets() 
	{
...

		{
			...
			AssetDatabase.CreateAsset(overrideController, "Assets/Resources/AnimaCtrl/Roles/102005@Over.overrideController");
	...
	private static void NewRoleOverFromRoleControler (string strRoleID,string strRolePartName, ref AnimatorOverrideController overrideController)
	{
		...
		AddStateTransition (strRoleID,strRolePartName,"10700","10700","", ref overrideController);
		AddStateTransition (strRoleID,strRolePartName,"10800","10800","", ref overrideController);
