...
public class RoleAnimator200005 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/200005-刀盾企鹅")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "200005";
		string strRolePartName="200005";
...

		{
			...
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/Roles/200005@Over.overrideController");
