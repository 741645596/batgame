...
public class RoleAnimator100003 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/100003-蹦大")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "100003";
		string strRolePartName="100003";
...

		{
				...
				AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/100003@Over.overrideController");
