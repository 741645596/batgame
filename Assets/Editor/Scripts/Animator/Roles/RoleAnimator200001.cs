...
public class RoleAnimator200001 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/200001-瑞哥")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "200001";
		string strRolePartName="200001";
...

		{
				...
				AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/200001@Over.overrideController");
				AssetDatabase.SaveAssets ();
		}

		{
	            strRolePartName="200001_toujin";
				AnimatorOverrideController overrideController = new AnimatorOverrideController ();
				overrideController.runtimeAnimatorController = AssetDatabase.LoadAssetAtPath (strRoleTemplateContrller, typeof(UnityEditor.Animations.AnimatorController)) as UnityEditor.Animations.AnimatorController;
				NewRoleOverFromRoleControler (strRoleID, strRolePartName, ref overrideController);
	            AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/200001_toujin@Over.overrideController");
				AssetDatabase.SaveAssets ();

		}
		{
			strRolePartName="200001_wuqi";
			AnimatorOverrideController overrideController = new AnimatorOverrideController ();
			overrideController.runtimeAnimatorController = AssetDatabase.LoadAssetAtPath (strRoleTemplateContrller, typeof(UnityEditor.Animations.AnimatorController)) as UnityEditor.Animations.AnimatorController;
			NewRoleOverFromRoleControler (strRoleID, strRolePartName, ref overrideController);
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/200001_wuqi@Over.overrideController");
			AssetDatabase.SaveAssets ();
