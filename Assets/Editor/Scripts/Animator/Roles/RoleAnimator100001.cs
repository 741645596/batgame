...
public class RoleAnimator100001 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/100001-duangduang")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "100001";
		string strRolePartName="100001";
...

		{
			...
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/100001@Over.overrideController");
