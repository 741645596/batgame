...
public class RoleAnimator200007 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/200007-弓箭企鹅")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "200007";
		string strRolePartName="200007";
...

		{
			...
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/Roles/200007@Over.overrideController");
