...
public class RoleAnimator101004 : Editor {
    [MenuItem("Tool/AnimatorOver/Roles/101004-雷神猫")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
        string strRoleID = "101004";
        string strRolePartName = "101004";
...

		{
                ...
                AssetDatabase.CreateAsset(overrideController, "Assets/Resources/AnimaCtrl/Roles/101004@Over.overrideController");
