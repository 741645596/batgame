...
public class RoleAnimator102003_2 : MonoBehaviour {

	[MenuItem("Tool/AnimatorOver/Roles/102003_2-绿巨熊")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "102003_2";
		string strRolePartName = "102003_2";
		...
		
		{
			...
			AssetDatabase.CreateAsset(overrideController, "Assets/Resources/AnimaCtrl/Roles/102003_2@Over.overrideController");
	...
	private static void NewRoleOverFromRoleControler (string strRoleID,string strRolePartName, ref AnimatorOverrideController overrideController)
	{
		...
		AddStateTransition (strRoleID,strRolePartName,"85100","85100","", ref overrideController);
		AddStateTransition (strRoleID,strRolePartName,"85200","85200","", ref overrideController);
