...
/// 一刀喵
/// </summary>
public class RoleAnimator101001 : Editor
{
	[MenuItem("Tool/AnimatorOver/Roles/101001-一刀喵")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "101001";
		string strRolePartName = "101001";
...

		{
			...
			AssetDatabase.CreateAsset(overrideController, "Assets/Resources/AnimaCtrl/Roles/101001@Over.overrideController");
				AssetDatabase.SaveAssets ();
		}

		/*{
			strRolePartName="101001_toujin";
			AnimatorOverrideController overrideController = new AnimatorOverrideController ();
			...
			NewRoleOverFromRoleControler (strRoleID, strRolePartName, ref overrideController);
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/101001_toujin@Over.overrideController");
			AssetDatabase.SaveAssets ();
	...
	private static void NewRoleOverFromRoleControler (string strRoleID,string strRolePartName, ref AnimatorOverrideController overrideController)
	{
		...
		AddStateTransition (strRoleID,strRolePartName,"80030","80000","", ref overrideController);
