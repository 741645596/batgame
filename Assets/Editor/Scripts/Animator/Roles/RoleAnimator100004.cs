...
public class RoleAnimator100004 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/100004-二百")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "100004";
		string strRolePartName="100004";
...

		{
				...
				AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/100004@Over.overrideController");
	...
	private static void NewRoleOverFromRoleControler (string strRoleID,string strRolePartName, ref AnimatorOverrideController overrideController)
	{
		...
		AddStateTransition (strRoleID,strRolePartName,"81200","81200","", ref overrideController);
		AddStateTransition (strRoleID,strRolePartName,"81300","81300","", ref overrideController);
