...
/// 熊孩子
/// </summary>
public class RoleAnimator102004 : Editor
{
    [MenuItem("Tool/AnimatorOver/Roles/102004-维京熊")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
        string strRoleID = "102004";
        string strRolePartName = "102004";
...

		{
			...
			AssetDatabase.CreateAsset(overrideController, "Assets/Resources/AnimaCtrl/Roles/102004@Over.overrideController");
