...
public class RoleAnimator103002 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/103002-黑胡子")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "103002";
		string strRolePartName="103002";
...

		{
			...
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/Roles/103002@Over.overrideController");
				AssetDatabase.SaveAssets ();
		}
		
		
	/*	{
	            strRolePartName="100002_toujin";
				AnimatorOverrideController overrideController = new AnimatorOverrideController ();
				overrideController.runtimeAnimatorController = AssetDatabase.LoadAssetAtPath (strRoleTemplateContrller, typeof(AnimatorController)) as AnimatorController;
				NewRoleOverFromRoleControler (strRoleID, strRolePartName, ref overrideController);
	            AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/100002_toujin@Over.overrideController");
				AssetDatabase.SaveAssets ();

		}
		{
			strRolePartName="100002_wuqi";
			AnimatorOverrideController overrideController = new AnimatorOverrideController ();
			overrideController.runtimeAnimatorController = AssetDatabase.LoadAssetAtPath (strRoleTemplateContrller, typeof(AnimatorController)) as AnimatorController;
			NewRoleOverFromRoleControler (strRoleID, strRolePartName, ref overrideController);
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/100002_wuqi@Over.overrideController");
			AssetDatabase.SaveAssets ();
	...
	private static void NewRoleOverFromRoleControler (string strRoleID,string strRolePartName, ref AnimatorOverrideController overrideController)
	{
		...
		AddStateTransition (strRoleID,strRolePartName,"00400","00400","", ref overrideController);
		...
		AddStateTransition(strRoleID, strRolePartName, "10210", "10210", "", ref overrideController);
		AddStateTransition(strRoleID, strRolePartName, "10300", "10300", "", ref overrideController);
		AddStateTransition(strRoleID, strRolePartName, "10310", "10310", "", ref overrideController);
		...
		AddStateTransition (strRoleID,strRolePartName,"10503","10500","", ref overrideController);
		...
		AddStateTransition (strRoleID,strRolePartName,"86000","86000","", ref overrideController);
		AddStateTransition (strRoleID,strRolePartName,"87000","87000","", ref overrideController);
	}
