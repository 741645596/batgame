...
public class RoleAnimator200004 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/200004-企鹅医师")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "200004";
		string strRolePartName="200004";
...

		{
			...
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/Roles/200004@Over.overrideController");
