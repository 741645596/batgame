...
public class RoleAnimator101002 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/101002-金钱猫")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "101002";
		string strRolePartName="101002";
		string strRoleTemplateContrller="Assets/Resources/AnimaCtrl/Role@Controller.controller";

		{
				...
				AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/101002@Over.overrideController");
				AssetDatabase.SaveAssets ();
		}

		{
			
			strRolePartName="101002_bao";
			AnimatorOverrideController overrideController = new AnimatorOverrideController ();
			overrideController.runtimeAnimatorController = AssetDatabase.LoadAssetAtPath (strRoleTemplateContrller, typeof(UnityEditor.Animations.AnimatorController)) as UnityEditor.Animations.AnimatorController;
			NewRoleOverFromRoleControler (strRoleID, strRolePartName, ref overrideController);
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/101002_bao@Over.overrideController");
			AssetDatabase.SaveAssets ();
		}
		
		
		{
	            strRolePartName="101002_toujin";
				AnimatorOverrideController overrideController = new AnimatorOverrideController ();
				overrideController.runtimeAnimatorController = AssetDatabase.LoadAssetAtPath (strRoleTemplateContrller, typeof(UnityEditor.Animations.AnimatorController)) as UnityEditor.Animations.AnimatorController;
				NewRoleOverFromRoleControler (strRoleID, strRolePartName, ref overrideController);
	            AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/101002_toujin@Over.overrideController");
				AssetDatabase.SaveAssets ();

		}
		{
			strRolePartName="101002_wuqi";
			AnimatorOverrideController overrideController = new AnimatorOverrideController ();
			overrideController.runtimeAnimatorController = AssetDatabase.LoadAssetAtPath (strRoleTemplateContrller, typeof(UnityEditor.Animations.AnimatorController)) as UnityEditor.Animations.AnimatorController;
			NewRoleOverFromRoleControler (strRoleID, strRolePartName, ref overrideController);
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/101002_wuqi@Over.overrideController");
			AssetDatabase.SaveAssets ();
