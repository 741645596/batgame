...
/// 熊孩子
/// </summary>
public class RoleAnimator102002 : Editor
{
	[MenuItem("Tool/AnimatorOver/Roles/102002-大奶熊")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "102002";
		string strRolePartName = "102002";
		...
		
		{
			...
			AssetDatabase.CreateAsset(overrideController, "Assets/Resources/AnimaCtrl/102002@Over.overrideController");
	...
	private static void NewRoleOverFromRoleControler (string strRoleID,string strRolePartName, ref AnimatorOverrideController overrideController)
	{
		...
		AddStateTransition (strRoleID,strRolePartName,"80100","80100","", ref overrideController);
	}
	/// <summary>
	/// 添加状态
	/// </summary>
