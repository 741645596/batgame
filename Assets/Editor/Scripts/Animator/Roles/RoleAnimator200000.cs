...
public class RoleAnimator200000 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/200000-duangduang")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "200000";
		string strRolePartName="200000";
...

		{
			...
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/200000@Over.overrideController");
