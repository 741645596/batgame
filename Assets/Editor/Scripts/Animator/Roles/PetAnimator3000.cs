...
public class PetAnimator3000 : Editor {
	[MenuItem("Tool/AnimatorOver/Pets/3000-拆解机器人")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "3000";
		string strRolePartName="3000";
...

		{
			...
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/Summonpet/3000@Over.overrideController");
	...
	private static void NewRoleOverFromRoleControler (string strRoleID,string strRolePartName, ref AnimatorOverrideController overrideController)
	{
		...
		AddStateTransition (strRoleID,strRolePartName,"00210","00210","", ref overrideController);
	...
	{
		bool bPair = false;
		string strCliPath = "Assets/Models/Summonpet/"+strRoleID+"/"+strRolePartName+"@Ani/"+strRolePartName+"@"+strClipSourceName+".FBX";
		if(strClipName=="")
