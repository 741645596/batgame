...
public class RoleAnimator200003 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/200003-自爆企鹅")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "200003";
		string strRolePartName="200003";
...

		{
			...
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/Roles/200003@Over.overrideController");
