...
public class RoleAnimator200006 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/200006-弓弩手")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "200006";
		string strRolePartName="200006";
...

		{
			...
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/Roles/200006@Over.overrideController");
