...
public class RoleAnimator200002 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/200002-巫师企鹅")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "200002";
		string strRolePartName="200002";
...

		{
			...
			AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/Roles/200002@Over.overrideController");
