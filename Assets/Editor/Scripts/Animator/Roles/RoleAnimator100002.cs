...
public class RoleAnimator100002 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/100002-瑞哥")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "100002";
		string strRolePartName="100002";
...

		{
				...
				AssetDatabase.CreateAsset (overrideController, "Assets/Resources/AnimaCtrl/Roles/100002@Over.overrideController");
