...
public class RoleAnimator102003 : Editor {
	[MenuItem("Tool/AnimatorOver/Roles/102003-熊猫博士")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
		string strRoleID = "102003";
		string strRolePartName = "102003";
		...
		
		{
			...
			AssetDatabase.CreateAsset(overrideController, "Assets/Resources/AnimaCtrl/Roles/102003@Over.overrideController");
