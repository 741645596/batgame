...
/// 熊孩子
/// </summary>
public class RoleAnimator102001 : Editor
{
    [MenuItem("Tool/AnimatorOver/Roles/102001-熊孩子")]
	
	static void DoCreateAnimationAssets() 
	{
		//创建animationController文件，保存在Assets路径下
        string strRoleID = "102001";
        string strRolePartName = "102001";
...

		{
                ...
                AssetDatabase.CreateAsset(overrideController, "Assets/Resources/AnimaCtrl/102001@Over.overrideController");
