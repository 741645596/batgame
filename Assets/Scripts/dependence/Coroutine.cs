...
public class Coroutine
{
	...
	public static YCCoroutine DispatchService(IEnumerator c)
	{
		return DispatchService(c, null, null);
	}
	public static YCCoroutine DispatchService(IEnumerator c, GameObject owner)
	{
		return DispatchService(c, owner, null);
	}
}
...
public class YCCoroutine : IYYieldInstruction
{
	...
	public void Error()
	{
		if (f != null)
		{
			try { f(); } catch (Exception e) { UnityEngine.Debug.LogError(e); }
		}
	}
}
