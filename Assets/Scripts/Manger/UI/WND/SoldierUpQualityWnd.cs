...
/// <Author>QFord</Author>
/// </summary>
public class SoldierUpQualityWnd : WndTopBase
{

    public SoldierUpQualityWnd_h MyHead {
        get
        {
            return (base.BaseHead() as SoldierUpQualityWnd_h);
            ;
        }
    }
    ...
    public void SetSoldierPhoto(int id)
    {
        NGUIUtil.Set2DSprite(MyHead.Spr2dPic, "Textures/Temp/", "qualityup" + id.ToString());
    }
